...
async fn handle_connection(
    ...
    if let Some((code, role)) = membership {
        ...
        // Whoever left, the room can no longer pair a fresh 1:1 session —
        // simplest correct behavior for this personal-use scale is to just
        // drop it and let the remaining side reconnect/host again.
